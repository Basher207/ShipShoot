class AkhilsShip extends Character {
    ...
    void Move () {
        ...
        velocity= new PVector(follow.x-position.x,follow.y-position.y); //the velocity is set to the vector between the ship's position adn the object being followed
